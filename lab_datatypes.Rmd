...
In many cases the mode of an entry is determined by the content. So if you save the value 5.1 as a variable in R, the variable will automatically be recognised as numeric. If you instead have a text string like "hello world" it will have the mode character. Below you will also see examples of how you can specify the mode and not rely on R inferring the right mode based on content.
...
11. Multiply a logical TRUE by a logical FALSE. Rise the logical true to the 7-th power.
...
- Check for all occurrences of *select* in the help.  
...
- Install the 'dplyr' package from GitHub.  
- Look up the 'dplyr' vignette.  
...
- Install the R-Forge package 'bigRR' or 'Matrix'. 
