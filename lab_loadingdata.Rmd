...
if(!file.exists("Drosophila_melanogaster.BDGP6.86.gtf") && !file.exists("Drosophila_melanogaster.BDGP6.86.gtf.gz")) download.file("ftp://ftp.ensembl.org/pub/release-86/gtf/drosophila_melanogaster/Drosophila_melanogaster.BDGP6.86.gtf.gz","Drosophila_melanogaster.BDGP6.86.gtf.gz")
