...
umea <- data.frame(
  ...
  description = "[Umeå city buses](http://tabussen.nu/):<br>Pay your bus ticket on the bus (credit card only), or in advance in the ticket machines at Vasaplan or Umeå Airport, or at any Reseinfo centre. It is cheaper to buy the ticket in advance. You can also use the Ultra app.",
  stringsAsFactors = F
)
...
uppsala <- data.frame(
  ...
  description = "Use the [UL website](www.ul.se) or the [UL app](https://www.ul.se/en/tickets/how-to-buy-a-ticket/the-UL-app/) for bus and train services around Uppsala. For buses from the Centralstation (Train/Bus), take Bus 4 (towards Gottsunda Centrum), 8 (towards Sunnersta), or 3 (towards Akademiska Rosendal) and get off at the stop *Uppsala Science Park*. Be aware that construction on the street in front of BMC might affect the exact location of the bus stop. Bus tickets can be purchased in the app or directly from the driver using a credit card. Enter the Biomedicinskt Centrum via the SciLifeLab entrance (C11).",
  stringsAsFactors = F
)
