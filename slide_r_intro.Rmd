...
# Where to start?
.pull-left-50[
```{r simple-chain-of-throught, echo = F}
...
graphics::text(0, 0.5, "Input", col = "darkorange", cex = 1.5)
graphics::text(0, -5.5, "Output", col = "darkorange", cex = 1.5)
...
graphics::text(0, 0.5, "Input", col = "darkorange", cex = 1.5)
graphics::text(0, -6.4, "Output", col = "darkorange", cex = 1.5)
