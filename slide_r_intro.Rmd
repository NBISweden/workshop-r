...
```{r top-down-approach-fig, echo = F, eval = T}
# Set up blank plot
plot(0, 0, type = "n", xlim = c(-4, 4), ylim = c(-5, 1),
     axes = FALSE, xlab = "", ylab = "", main = "Top Down Approach")

# Function to draw circle node
draw_node <- function(x, y, r = 0.3, col = "darkorange") {
...
# Add title in the same style
title(main = "Top Down Approach", col.main = "darkorange", font.main = 2)
...
# flowchart LR
#     
#         AA["CRAN"] --> A("Start once<br/>_renv::init()_")
#         BB["GitHub"] --> A
#         CC["Bioconductor"] --> A
#         subgraph Local["Local machine"]
#             A --> B["While working<br/>_renv::snapshot()_"]
#             B --> C["Share<br/>_renv.lock_"]
#     end
#     
# 
#     C --> D["Colleague<br/>_renv::restore()_"]
#     C --> E["Community<br/>_renv::restore()_"]
