---
title: "Elements of the R language: repeating actions, control structures, functions"
...
```{r fns.3dots, echo=T, fig.height = 3, fig.width = 3}
...
```{r fns.3dots.trick, echo=T, fig.height = 3, fig.width = 3}
