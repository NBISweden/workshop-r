...
- Creating a variable is simply assigning values to some names in order to store data...
...
```
`%s` is a spaceholder for inserting a string.    
`%g` is a spaceholder for inserting a numeric value into a formatted string.  
