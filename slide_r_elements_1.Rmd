---
title: "Elements of the R language: variables, data types, operators"
...
> `val <- 3`, `val = 3` and `val -> 3` are in R three equivalent ways of assigning, BUT you should use only `<-` to avoid possible confusion. The equal sign `=` you can and should use 
...
```{r casting.not.rounding2, echo=T}
